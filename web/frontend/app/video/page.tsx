  ...
  return (
    <div className="grid grid-cols-1 gap-6 lg:grid-cols-[340px_1fr]">
      <aside className="h-fit rounded-2xl border border-border bg-panel p-5">
        <h2 className="mb-1 text-lg font-bold">Video Enhancement</h2>
              ...
              <div className="mt-2">
                ...
                <div className="mt-3 flex flex-wrap items-center gap-3">
                  <a
                    ...
                    download
                    className="rounded-xl bg-accent-gradient px-4 py-2 text-sm font-bold text-base"
                  >
...
function StatusBadge({ status }: { status: JobStatus['status'] }) {
  ...
  return (
    <span
      className={`rounded-full border px-2.5 py-1 text-xs font-bold uppercase tracking-wide ${styles[status]}`}
    >
      {status}
    </span>
  );
